...
<body>
    ...
    <main>
        ...
        Class Camion extends Coche{
            ...
            function establece_color($modelo_camion,$color_camion){
                $this->modelo=$modelo_camion;
                $this->color=$color_camion;
                echo "El modelo de camión es ".$this->modelo. " y el color de este camión es: ".$this->color . "<br>";
                }
